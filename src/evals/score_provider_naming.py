...
Usage:
    ...
    python -m src.evals.score_provider_naming setup
    ...
    # 3. Score the results
    python -m src.evals.score_provider_naming score

    # 4. Clean up (closes PR, deletes branch, removes files)
    python -m src.evals.score_provider_naming cleanup
"""
import json
import shutil
import subprocess
...
def setup() -> None:
    ...
    print()
    print("Then: python -m src.evals.score_provider_naming score")
...
if __name__ == "__main__":
    ...
    if cmd == "setup":
        ...
        print("Usage: python -m src.evals.score_provider_naming [setup|score|cleanup]")
