...
Usage:
    python -m src.evals.score_ambient_provider setup
    python -m src.evals.score_ambient_provider score
    python -m src.evals.score_ambient_provider cleanup
"""
import sys
...
class ScoreAmbientProvider(EvalHarness):
    ...
    def setup(self) -> None:
        ...
        print("\nRun: python -m src.evals.score_ambient_provider score")
