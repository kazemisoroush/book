...
- type: "dialogue", "narration", "illustration", "copyright", "other", "sound_effect", "vocal_effect", "music", or "chapter_announcement"
...
**Background music cues (US-012):** When the narrative contains an emotional shift, \
scene change, rising tension, or moment that calls for underscore music, output a \
`type: "music"` segment at the point where the music should begin. The `text` field \
is a free-form natural-language music_description for the generation API \
(e.g., "tense orchestral strings building slowly, low rumble", \
"gentle piano, melancholic, slow tempo", "upbeat comedic theme, light and bouncy"). \
Music continues until the next music segment appears or the chapter ends. \
To end music explicitly, output a music segment with `text: "silence"`. \
The `speaker` field is always null for music segments. \
Only emit music cues when the narrative strongly implies a mood change or emotional beat. \
Do NOT invent music cues for every paragraph — be selective and deliberate.
...
Return ONLY a JSON object in this exact format:
{
  "segments": [
    ...
    {"type": "music", "text": "gentle piano, melancholic, slow tempo"},
