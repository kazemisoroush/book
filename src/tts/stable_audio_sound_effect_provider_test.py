...
from src.tts.stable_audio_sound_effect_provider import StableAudioSoundEffectProvider


@pytest.fixture
def mock_requests():
    """Mock requests module."""
    with patch("src.tts.stable_audio_sound_effect_provider.requests") as mock:
        yield mock
...
def test_stable_audio_sfx_cache_hit(tmp_path):
    ...
    # Act
    with patch("src.tts.stable_audio_sound_effect_provider.requests") as mock_requests:
        result = provider.generate(
