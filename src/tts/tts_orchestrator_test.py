...
class TestTTSOrchestratorEmotionWiring:
    """TTSOrchestrator passes segment.emotion to the TTS provider (US-009)."""

    def test_orchestrator_passes_emotion_value_to_provider(self, tmp_path: Path) -> None:
        """synthesize_chapter() must pass emotion='ANGRY' to provider.synthesize()."""
        # Arrange
        segment = Segment(
        ...
        # Stub ffmpeg stitching to avoid needing ffmpeg installed
        ...
        # Assert — synthesize was called with emotion='ANGRY'
    ...
    def test_orchestrator_passes_none_emotion_for_narration_segments(
        ...
        # Assert — emotion=None passed through
        call_kwargs = mock_provider.synthesize.call_args.kwargs
