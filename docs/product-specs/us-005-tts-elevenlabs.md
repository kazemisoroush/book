...
4. NARRATION and DIALOGUE segments are synthesised. ILLUSTRATION, COPYRIGHT, and OTHER segments are skipped.
5. Per-segment MP3s are stitched into `output/chapter_01.mp3` using ffmpeg.
...
- Caching previously synthesised segments
